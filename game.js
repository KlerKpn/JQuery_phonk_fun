...
context.drawImage(sasuke, p, w, 200, 200)
for(let i in bullet){ 
    context.drawImage(chidori, bullet[i].x, bullet[i].y, 200,200)
}

for(let i in enemy){ 
    context.drawImage(vrag, enemy[i].x , enemy[i].y, 100, 150)
}
}
